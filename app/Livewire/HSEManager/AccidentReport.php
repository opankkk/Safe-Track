...
class AccidentReport extends Component
{
    ...
    public function openApproveModal(int $id)
    {
        ...
        $this->selectedReportData = Report::with(['accidentDetail', 'pic'])->find($id);
        $this->managerNote = '';
    ...
    {
        $this->rejectReportId = $id;
        $this->selectedReportData = Report::with(['accidentDetail', 'action', 'pic'])->find($id);
        $this->managerRejectNote = '';
    ...
    {
        return view('livewire.h-s-e-manager.accident-report', [
