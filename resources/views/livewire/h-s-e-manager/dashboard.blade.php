              ...
              <div class="d-flex flex-column" style="gap:10px;">
                    ...
                    <div class="d-flex text-white"
                      ...
                      <div style="min-width:0;">
                        ...
                        <div style="font-size:10px; color:rgba(255,255,255,.9); font-weight:700;
                            ...
                            {{ $notif['status_label'] ?? 'Persetujuan' }}
                        </div>
                ...
                @empty
                  <div class="d-flex flex-column align-items-center justify-content-center text-muted"
                    ...
                    <div style="font-size:14px; font-weight:600;">Semua sudah diproses</div>
                    <small>Tidak ada plan atau report yang menunggu approval.</small>
                  </div>
                @endforelse
