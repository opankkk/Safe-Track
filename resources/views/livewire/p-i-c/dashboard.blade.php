{{-- resources/views/livewire/p-i-c/dashboard.blade.php --}}
        ...
        <div class="p-3 text-white position-relative overflow-hidden"
          ...
          <div class="position-absolute"
               style="left:50%; top:65%; transform:translate(-50%,-50%);
                      width:6px; height:6px; background:rgba(255,255,255,.85); border-radius:999px;"></div>
        </div>
      </div>
            ...
            <div class="mt-3 flex-grow-1" style="min-height:380px; position:relative;">
              ...
              @if(!$chartData['hasData'])
                ...
                <div class="d-flex flex-column align-items-center justify-content-center h-100 text-muted"
                  ...
                  <div style="font-size:14px; font-weight:700;">Belum ada data laporan yang ditutup (Close)</div>
          ...
          <div class="card-body d-flex flex-column">
            ...
            <div class="d-flex justify-content-between align-items-center" style="gap:8px;">
              <div>
                ...
                <small class="text-muted">Laporan menunggu aksi PIC.</small>
              </div>
              ...
              <div class="d-flex flex-column" style="gap:10px;">
                ...
                @empty
                  <div class="d-flex flex-column align-items-center justify-content-center text-muted"
                    ...
                    <div style="font-size:14px; font-weight:600;">Semua tugas sudah dikerjakan</div>
                    <small>Tidak ada laporan yang menunggu aksi PIC.</small>
                  </div>
                @endforelse
